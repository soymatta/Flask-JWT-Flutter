...
def get_professional_tips():
    ...
    return jsonify(
        [professional_tip.serialize() for professional_tip in professional_tips]
    )


# GET PROFESSIONAL TIP
...
def get_professional_tip(professional_tip_id):
    ...
    if professional_tip:
        ...
        return (
            jsonify(
                {
                    "error": "Professional Tip with id {} not found".format(
                        professional_tip_id
                    )
                }
            ),
...
# DELETE PROFESSIONAL TIP
@professional_tip_api.route(
    "/professional_tips/<professional_tip_id>", methods=["DELETE"]
)
@jwt_required()
def delete_professional_tip(professional_tip_id):
    ...
    if professional_tip:
        ...
        return jsonify(
            {
                "message": "Professional Tip with id {} deleted".format(
                    professional_tip_id
                )
            }
        )
