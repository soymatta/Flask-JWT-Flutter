...
class Nutritionist(db.Model):
    ...
    professional_tips = db.relationship('ProfessionalTip', backref='nutritionist', lazy=True)

    def __init__(self, name, email, password, description, photo, instagram, website, whatsapp, skill1, skill2, skill3):
        self.name = name
        self.email = email
